...
def create_optimizer(args):
    ...
    evaluator = FoxP2_evaluator.create(sim=args.sim)
...
def main():  # pylint: disable=too-many-statements
    ...
    if args.analyse:
        ...
        FoxP2_analysis.analyse_releasecircuit_model(
            opt=opt, figs=(
        ...
        if args.checkpoint is not None and os.path.isfile(args.checkpoint):
            ...
            FoxP2_analysis.analyse_cp(opt=opt,
                                     cp_filename=args.checkpoint,
        ...
        FoxP2_analysis.analyse_releasecircuit_hocmodel(
            opt=opt,
            fig=fig_release,
            box=box)
        ...
        FoxP2_analysis.plot_diversity(opt, args.diversity, fig_diversity,
