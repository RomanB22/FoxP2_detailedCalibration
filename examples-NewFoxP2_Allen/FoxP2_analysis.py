...
release_params = {
    ...
    'gbar_Kv3_1.somatic': 1e-1,
    'gbar_Kv3_1.apical': 1e-1,
    'gbar_Kv3_1.axonal': 1e-1,

    'gbar_Nap.somatic': 1e-4,
    'gbar_Nap.axonal': 1e-4,
    'gbar_K_T.somatic': 1e-3,
    'gbar_K_T.axonal': 1e-3,
    'gbar_K_P.somatic': 1e-4,
    'gbar_K_P.axonal': 1e-4,
    'gbar_SK.somatic': 1e-3,
    'gbar_SK.axonal': 1e-3,
    'gbar_Ih.somatic': 1e-3,
    'gbar_Ih.axonal': 1e-3,
    'gbar_Im.somatic': 1e-5,
    'gbar_Im.axonal': 1e-5,
    'gbar_Ca_HVA.somatic': 1e-4,
    'gbar_Ca_HVA.axonal': 1e-4,
    'gbar_Ca_LVA.somatic': 1e-2,
    'gbar_Ca_LVA.axonal': 1e-2,
    'gamma_CaDynamics.somatic': 1e-3,
    'gamma_CaDynamics.axonal': 1e-3,
    'decay_CaDynamics.somatic': 1e2,
    'decay_CaDynamics.axonal': 1e2
}
...
def plot_multiple_responses(responses, fig):
    ...
    traces = ('IDRest_0.soma.v', 'IDRest_100.soma.v', 'IDRest_200.soma.v', 'IDRest_300.soma.v', )
...
def analyse_releasecircuit_hocmodel(opt, fig=None, box=None):
    ...
    template_model = HocModel(morphname="./morphology/threeCompartmental.swc",
